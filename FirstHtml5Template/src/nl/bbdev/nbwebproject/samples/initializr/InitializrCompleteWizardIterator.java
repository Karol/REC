...
public class InitializrCompleteWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public InitializrCompleteWizardIterator() {
    }

    public static InitializrCompleteWizardIterator createIterator() {
        return new InitializrCompleteWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
                    new InitializrCompleteWizardPanel(),};
    }

    private String[] createSteps() {
        return new String[]{
                    NbBundle.getMessage(InitializrCompleteWizardIterator.class, "LBL_CreateProjectStep")
                };
    }
