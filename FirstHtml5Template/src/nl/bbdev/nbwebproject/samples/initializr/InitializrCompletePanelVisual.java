...
public class InitializrCompletePanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";
    private InitializrCompleteWizardPanel panel;

    public InitializrCompletePanelVisual(InitializrCompleteWizardPanel panel) {
        initComponents();
        this.panel = panel;
    ...
    void read(WizardDescriptor settings) {
        ...
        if (projectName == null) {
            projectName = "InitializrComplete";
        }
