...
public class BasicWebpagePanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";
    private BasicWebpageWizardPanel panel;

    public BasicWebpagePanelVisual(BasicWebpageWizardPanel panel) {
        initComponents();
        this.panel = panel;
