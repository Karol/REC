...
public class WebProject implements Project {
    ...
    WebProject(FileObject dir, ProjectState state) {
        this.projectDir = dir;
        this.state = state;
    }
    ...
    private final class Info implements ProjectInformation {
        ...
        @StaticResource()
        public static final String CUSTOMER_ICON = "nl/bbdev/nbwebproject/icon.png";
    ...
    class WebProjectLogicalView implements LogicalViewProvider {
        ...
        private final class ProjectNode extends FilterNode {
            ...
            public ProjectNode(Node node, WebProject project) throws DataObjectNotFoundException {
                super(node,
